...
// 下载
// file-blob
async function fileBlob(catalogItem: _Global.CatalogItem): Promise<string> {
...
interface DownloadType {
  fileBlob: (catalogItem: _Global.CatalogItem) => Promise<string>
  trees: (catalogItem: _Global.CatalogItem) => Promise<string[]>
}
